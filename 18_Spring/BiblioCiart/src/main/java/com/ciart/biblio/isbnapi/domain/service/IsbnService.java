package com.ciart.biblio.isbnapi.domain.service;

import com.ciart.biblio.isbnapi.domain.model.VolumeInfo;
import com.ciart.biblio.isbnapi.modelo.input.IsbnInputModel;
import com.ciart.biblio.isbnapi.modelo.input.BookInputModel;
import com.ciart.biblio.isbnapi.domain.exception.IsbnNotFoundException;
import com.ciart.biblio.isbnapi.domain.exception.MalformedIsbnException;
import com.ciart.biblio.isbnapi.domain.exception.IsbnInvalid;
